...
function schema(item,url,title,description,faq,breadcrumbs,type='Article'){
  const graph=[
    {'@type':'Organization','@id':`${origin}/#organization`,name:'Yadetout',url:origin,logo:`${origin}/icon.svg`},
    {'@type':'WebSite','@id':`${origin}/#website`,url:origin,name:'Yadetout',inLanguage:'fr-FR',publisher:{'@id':`${origin}/#organization`}},
